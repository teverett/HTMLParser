...
public class HTMLParser extends Parser {
	...
	public static final int
		OPEN=6, SEA_WS=5, HTML_DTD=2, HTML_STRING=12, HTML_EntityRef=3, HTML_Name=13, 
		HTML_SLASH=10, HTML_CharRef=4, HTML_SLASH_CLOSE=9, HTML_COMMENT=1, HTML_TEXT=7, 
		S=14, HTML_EQUALS=11, HTML_CLOSE=8;
	public static final String[] tokenNames = {
		"<INVALID>", "HTML_COMMENT", "HTML_DTD", "HTML_EntityRef", "HTML_CharRef", 
		"SEA_WS", "'<'", "HTML_TEXT", "'>'", "'/>'", "'/'", "'='", "HTML_STRING", 
		"HTML_Name", "S"
	};
	public static final int
		RULE_htmlDocument = 0, RULE_htmlElements = 1, RULE_htmlElement = 2, RULE_htmlContent = 3, 
		RULE_htmlReference = 4, RULE_htmlAttribute = 5, RULE_htmlChardata = 6, 
		RULE_htmlMisc = 7, RULE_htmlComment = 8;
	public static final String[] ruleNames = {
		"htmlDocument", "htmlElements", "htmlElement", "htmlContent", "htmlReference", 
	...
	public static class HtmlDocumentContext extends ParserRuleContext {
		...
		public TerminalNode HTML_DTD() { return getToken(HTMLParser.HTML_DTD, 0); }
	...
	public static class HtmlElementContext extends ParserRuleContext {
		...
		public TerminalNode HTML_SLASH() { return getToken(HTMLParser.HTML_SLASH, 0); }
		public List<TerminalNode> HTML_Name() { return getTokens(HTMLParser.HTML_Name); }
	...
	public final HtmlElementContext htmlElement() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(40); match(OPEN);
				setState(41); match(HTML_Name);
				setState(45);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==HTML_Name) {
				...
				setState(48); match(HTML_CLOSE);
				setState(49); htmlContent();
				setState(50); match(OPEN);
				setState(51); match(HTML_SLASH);
				setState(52); match(HTML_Name);
				setState(53); match(HTML_CLOSE);
				}
				break;
			...
			case 2:
				...
				{
				setState(55); match(OPEN);
				setState(56); match(HTML_Name);
				setState(60);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==HTML_Name) {
				...
				setState(63); match(HTML_SLASH_CLOSE);
				}
				break;
			}
		}
		...
		try {
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case OPEN:
						{
						setState(69); htmlElement();
						}
						break;
					case HTML_EntityRef:
					case HTML_CharRef:
						{
						setState(70); htmlReference();
						}
						break;
					case HTML_COMMENT:
						{
						setState(71); htmlComment();
						}
						break;
					default:
	...
	public static class HtmlReferenceContext extends ParserRuleContext {
		public TerminalNode HTML_CharRef() { return getToken(HTMLParser.HTML_CharRef, 0); }
		public TerminalNode HTML_EntityRef() { return getToken(HTMLParser.HTML_EntityRef, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HTMLParserListener ) ((HTMLParserListener)listener).enterHtmlReference(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HTMLParserListener ) ((HTMLParserListener)listener).exitHtmlReference(this);
		}
	}
	...
	public static class HtmlAttributeContext extends ParserRuleContext {
		...
		public TerminalNode HTML_EQUALS() { return getToken(HTMLParser.HTML_EQUALS, 0); }
	...
	public final HtmlAttributeContext htmlAttribute() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState